...
func TestMatchesDefaultKeyMap(t *testing.T) {
	tests := []struct {
		...
		{BlockGlobal, ActionFocusABTests, "6", true},
		{BlockGlobal, ActionFocusPersonalizations, "7", true},
		{BlockGlobal, ActionFocusRollouts, "8", true},
		{BlockGlobal, ActionFocusPromote, "9", true},
		{BlockGlobal, ActionFocusDetails, "5", true},
		{BlockGlobal, ActionWorkspaceMenu, "\\", true},
		{BlockGlobal, ActionThemes, "ctrl+t", true},
		{BlockThemePicker, ActionSubmit, "enter", true},
		{BlockThemePicker, ActionCancel, "esc", true},
		{BlockWorkspaceMenu, ActionSubmit, "enter", true},
		{BlockWorkspaceMenu, ActionCancel, "esc", true},
