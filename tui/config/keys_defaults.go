...
func DefaultKeyMap() KeyMap {
	return KeyMap{
		BlockGlobal: {
			...
			ActionFocusABTests:          {"6"},
			ActionFocusPersonalizations: {"7"},
			ActionFocusRollouts:         {"8"},
