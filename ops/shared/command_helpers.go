...
// CommandContext returns the frontend-owned invocation context and falls back
// only for standalone command tests and embedders that did not set one.
func CommandContext(cmd invocation.Call) context.Context {
...
func WriteJSON(cmd invocation.Call, v any) error {
