...
func ConfirmFileOverwrite(cmd invocation.Call, path string, yes bool) (overwrite, proceed bool, err error) {
...
func ConfirmFileOverwriteWithoutBypass(cmd invocation.Call, path string) (overwrite, proceed bool, err error) {
	return confirmFileOverwrite(cmd, path, false, false)
}

func confirmFileOverwrite(cmd invocation.Call, path string, yes, allowBypass bool) (overwrite, proceed bool, err error) {
