...
func AddPlanOutFlag(cmd invocation.FlagGroups) {
...
func PlanOutputPath(cmd invocation.Call) (string, bool, error) {
	return planflag.OutputPath(cmd)
}

func AddChangeNoteFlag(cmd invocation.FlagGroups) {
	cmd.Flags().String("change-note", "", "Change note for publication or the stored draft")
}

func ReadChangeNoteFlag(cmd invocation.Call) (*string, error) {
...
func AddYesFlag(cmd invocation.FlagGroups, help string) {
...
func ValidateNonBlankInputs(cmd invocation.Call, args []string) error {
...
func stringFlagValues(cmd invocation.Call, flag *pflag.Flag) ([]string, bool, error) {
...
func ValidateQueryFlags(cmd invocation.Call) error {
...
func RejectChangedFlags(cmd invocation.Call, mode string, names ...string) error {
