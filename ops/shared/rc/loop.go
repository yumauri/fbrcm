...
import (
	...
	"github.com/yumauri/fbrcm/ops/shared/planflag"
)
...
func RunRemoteDraftLoop(ctx context.Context, cmd invocation.Call, svc *core.Core, projects []core.Project, defaultScope bool, operation string, plan RemoteMutationPlanner) (RemoteMutationTotals, error) {
...
func RunRemotePublishLoop(ctx context.Context, cmd invocation.Call, svc *core.Core, projects []core.Project, defaultScope bool, operation, publishedEmoji string, plan RemoteMutationPlanner) (RemoteMutationTotals, error) {
...
func WriteRemoteMutationResults(cmd invocation.Call, totals RemoteMutationTotals, operation, publishedEmoji string) error {
	jsonOut, _ := cmd.Flags().GetBool("json")
	if totals.Plan != nil {
		if jsonOut {
...
func writeRemoteMutationJSON(cmd invocation.Call, totals RemoteMutationTotals, draft, dryRun bool) error {
...
func writeMutationResult(cmd invocation.Call, result RemoteMutationResult, publishedEmoji string) {
...
func writeMutationRecoveryHints(cmd invocation.Call, totals RemoteMutationTotals, operation string) {
