...
func NewDefinition(svc *core.Core) *invocation.Definition {
	projectsCmd := &invocation.Definition{
		Use:   "projects",
		Short: "Manage Firebase projects for Remote Config",
	}
	projectsCmd.AddCommand(newListCommandDefinition(svc), newUpdateCommandDefinition(svc), newForgetCommandDefinition(svc), newDiffCommandDefinition(svc), newPromoteCommandDefinition(svc), newAliasesCommandDefinition(), newPathCommandDefinition(), newResetCommandDefinition(svc))
	invocation.MustRegisterResponsePath(projectsCmd, "list", []shared.ProjectJSON{})
	invocation.MustRegisterResponsePath(projectsCmd, "update", []shared.ProjectJSON{})
	invocation.MustRegisterResponsePath(projectsCmd, "forget", projectsForgetResult{})
	invocation.MustRegisterResponsePath(projectsCmd, "diff", compareResult{})
	invocation.MustRegisterResponsePath(projectsCmd, "promote", promoteResult{}, sharedrc.PlanCreatedResult{})
	invocation.MustRegisterResponsePath(projectsCmd, "aliases list", []projectAliasRow{})
	invocation.MustRegisterResponsePath(projectsCmd, "aliases set", projectAliasSetResult{})
	invocation.MustRegisterResponsePath(projectsCmd, "aliases remove", projectAliasRemoveResult{})
	invocation.MustRegisterResponsePath(projectsCmd, "aliases import", projectAliasImportResult{})
	invocation.MustRegisterResponsePath(projectsCmd, "path", shared.PathResult{})
	invocation.MustRegisterResponsePath(projectsCmd, "reset", projectsResetResult{})
	return projectsCmd
}

func newForgetCommandDefinition(svc *core.Core) *invocation.Definition {
...
func newUpdateCommandDefinition(svc *core.Core) *invocation.Definition {
	cmd := &invocation.Definition{
		Use:   "update",
...
func addProjectOutputFlags(cmd invocation.FlagGroups) {
...
func newResetCommandDefinition(svc *core.Core) *invocation.Definition {
	cmd := &invocation.Definition{
		Use:   "reset",
