...
func newAliasesCommandDefinition() *invocation.Definition {
	cmd := &invocation.Definition{Use: "aliases", Short: "Manage repository project aliases"}
	cmd.AddCommand(newAliasesListCommandDefinition(), newAliasesSetCommandDefinition(), newAliasesRemoveCommandDefinition(), newAliasesImportCommandDefinition())
	return cmd
}

func newAliasesListCommandDefinition() *invocation.Definition {
...
func newAliasesSetCommandDefinition() *invocation.Definition {
	cmd := &invocation.Definition{
...
func newAliasesRemoveCommandDefinition() *invocation.Definition {
	cmd := &invocation.Definition{
		Use:   "remove <alias>",
