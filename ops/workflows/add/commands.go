...
func addFlags(cmd invocation.FlagGroups) {
...
func runAddCommand(cmd invocation.Call, svc *core.Core, args []string) error {
...
func readAddOptions(cmd invocation.Call, args []string) (addOptions, error) {
...
func readAddValueSpec(cmd invocation.Call) (addValueSpec, error) {
...
func runAddRemote(cmd invocation.Call, svc *core.Core, opts addOptions) error {
...
func addProject(cmd invocation.Call, project core.Project, current *firebase.RemoteConfig, key, groupName, description string, spec addValueSpec, yes bool) (bool, *firebase.RemoteConfig, error) {
...
func runAddStdin(cmd invocation.Call, key, groupName, description string, spec addValueSpec, projectExpr string) error {
