...
func confirmAndUpdateProject(cmd invocation.Call, label string, cfg *firebase.RemoteConfig, matched []shared.ParamTarget, spec updateSpec, yes bool, diffOut io.Writer) ([]shared.ParamTarget, *firebase.RemoteConfig, error) {
