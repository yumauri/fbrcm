...
func writeRowsJSON(cmd invocation.Call, rows []parameterRow) error {
...
func loadStdinParameterRows(cmd invocation.Call, compiledExpr *filter.Expression, search shared.ParameterSearch) (*firebase.RemoteConfig, []parameterRow, error) {
...
func loadStdinDirectoryParameterRows(cmd invocation.Call, projectFilters []string, projectExpr string, search shared.ParameterSearch) (bool, []parameterRow, error) {
