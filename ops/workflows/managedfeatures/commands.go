...
func NewExperimentsDefinition(svc *core.Core) *invocation.Definition {
	...
	cmd.AddCommand(newExperimentsListCommandDefinition(svc), newExperimentsShowCommandDefinition(svc), newExperimentsDeleteCommandDefinition(svc))
	invocation.MustRegisterResponsePath(cmd, "list", []core.ExperimentEntry{})
	invocation.MustRegisterResponsePath(cmd, "show", experimentShowResult{})
	invocation.MustRegisterResponsePath(cmd, "delete", managedFeatureDeleteResult{})
	return cmd
}

func NewRolloutsDefinition(svc *core.Core) *invocation.Definition {
	cmd := &invocation.Definition{
		Use:   "rollouts",
	...
	cmd.AddCommand(newRolloutsListCommandDefinition(svc), newRolloutsShowCommandDefinition(svc), newRolloutsDeleteCommandDefinition(svc))
	invocation.MustRegisterResponsePath(cmd, "list", []core.RolloutEntry{})
	invocation.MustRegisterResponsePath(cmd, "show", rolloutShowResult{})
	invocation.MustRegisterResponsePath(cmd, "delete", managedFeatureDeleteResult{})
	return cmd
}

func NewPersonalizationsDefinition(svc *core.Core) *invocation.Definition {
	cmd := &invocation.Definition{
	...
	cmd.AddCommand(newPersonalizationsListCommandDefinition(svc), newPersonalizationsShowCommandDefinition(svc))
	invocation.MustRegisterResponsePath(cmd, "list", []core.PersonalizationEntry{})
	invocation.MustRegisterResponsePath(cmd, "show", personalizationShowResult{})
	return cmd
}
...
func newExperimentsListCommandDefinition(svc *core.Core) *invocation.Definition {
	cmd := &invocation.Definition{
		Use:   "list <project>",
...
func newExperimentsShowCommandDefinition(svc *core.Core) *invocation.Definition {
	cmd := &invocation.Definition{
...
func newExperimentsDeleteCommandDefinition(svc *core.Core) *invocation.Definition {
	cmd := &invocation.Definition{
...
func newRolloutsListCommandDefinition(svc *core.Core) *invocation.Definition {
	cmd := &invocation.Definition{
		Use:   "list <project>",
...
func newRolloutsShowCommandDefinition(svc *core.Core) *invocation.Definition {
	cmd := &invocation.Definition{
...
func newRolloutsDeleteCommandDefinition(svc *core.Core) *invocation.Definition {
	cmd := &invocation.Definition{
...
func newPersonalizationsListCommandDefinition(svc *core.Core) *invocation.Definition {
	cmd := &invocation.Definition{
		Use:   "list <project>",
...
func newPersonalizationsShowCommandDefinition(svc *core.Core) *invocation.Definition {
	cmd := &invocation.Definition{
...
func resolveProject(cmd invocation.Call, svc *core.Core, query string) (core.Project, error) {
	project, _, err := resolveProjectForExecution(cmd, svc, query)
	return project, err
}

func resolveProjectForExecution(cmd invocation.Call, svc *core.Core, query string) (core.Project, context.Context, error) {
...
func resolveReadProject(cmd invocation.Call, svc *core.Core, query string) (core.Project, context.Context, error) {
	target, explicit, err := rctarget.ParsePositionalSelector(query)
	if err != nil {
		return core.Project{}, nil, shared.InvalidArgument(err)
	}
...
func confirmManagedFeatureDelete(cmd invocation.Call, yes bool, prompt string) (bool, error) {
	if yes {
		return true, nil
	}
...
func printTemplateContext(cmd invocation.Call, project core.Project, template core.ManagedFeatureTemplate) {
	_, _ = fmt.Fprintf(
		cmd.OutOrStdout(),
