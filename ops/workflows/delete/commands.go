...
func NewDefinition(svc *core.Core) *invocation.Definition {
	...
	addDeleteFlags(cmd)
	invocation.RegisterResponse(cmd, []rc.RemoteMutationJSONResult{}, rc.PlanCreatedResult{}, contract.ArtifactData{})
	return cmd
}

func addDeleteFlags(cmd invocation.FlagGroups) {
...
func runDeleteCommand(cmd invocation.Call, svc *core.Core, args []string) error {
...
func readDeleteOptions(cmd invocation.Call, args []string) (deleteOptions, error) {
...
func runDeleteRemote(cmd invocation.Call, svc *core.Core, opts deleteOptions) error {
	totals, err := shared.RunParameterMutationRemote(cmd, svc, opts.ParameterMutationOpts, "delete", "🗑️", func(cmd invocation.Call, project core.Project, current *firebase.RemoteConfig, matched []shared.ParamTarget, yes bool) (int, *firebase.RemoteConfig, error) {
...
func runDeleteStdin(cmd invocation.Call, paramFilters []string, paramArgument *string, projectExpr string, search shared.ParameterSearch) error {
...
func confirmAndDeleteProject(cmd invocation.Call, label string, cfg *firebase.RemoteConfig, matched []shared.ParamTarget, yes bool, diffOut io.Writer) ([]shared.ParamTarget, *firebase.RemoteConfig, error) {
