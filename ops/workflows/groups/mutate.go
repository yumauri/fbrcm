...
func newAddCommandDefinition(svc *core.Core) *invocation.Definition {
	cmd := &invocation.Definition{Use: "add <name>", Short: "Add an empty parameter group across projects", Args: invocation.ExactArgs(1), RunE: func(cmd invocation.Call, args []string) error {
...
func newEditCommandDefinition(svc *core.Core) *invocation.Definition {
	cmd := &invocation.Definition{Use: "edit <group>", Short: "Edit a group description across projects", Args: invocation.ExactArgs(1), RunE: func(cmd invocation.Call, args []string) error {
...
func readDescriptionEdit(cmd invocation.Call) (string, error) {
...
func newRenameCommandDefinition(svc *core.Core) *invocation.Definition {
	cmd := &invocation.Definition{Use: "rename <group> <new-name>", Short: "Rename a parameter group across projects", Args: invocation.ExactArgs(2), RunE: func(cmd invocation.Call, args []string) error {
...
func newDeleteCommandDefinition(svc *core.Core) *invocation.Definition {
	cmd := &invocation.Definition{Use: "delete <group>", Short: "Delete a group across projects", Args: invocation.ExactArgs(1), RunE: func(cmd invocation.Call, args []string) error {
...
func runNamedGroupMutation(cmd invocation.Call, svc *core.Core, requested string, opts mutationOptions, operation, emoji string, destructive bool, mutate func(*firebase.RemoteConfig, string) (bool, error)) error {
...
func runGroupMutation(cmd invocation.Call, svc *core.Core, opts mutationOptions, operation, emoji string, destructive bool, mutate groupMutation) error {
