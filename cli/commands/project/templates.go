...
func newTemplatesCommand(svc *core.Core) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "templates",
		Short: "Manage a project's default template selection",
	}
	cmd.AddCommand(newTemplatesShowCommand(), newTemplatesSetCommand(svc))
	return cmd
}
...
func writeProjectTemplates(cmd *cobra.Command, project core.Project, jsonOut bool) error {
