...
func TestRenderVersionsTablePlainText(t *testing.T) {
	...
	table := renderVersionsTableAtWidth([]core.RemoteConfigVersionEntry{{
		VersionNumber: "42", UpdateTime: "2026-07-11T12:10:11Z", UpdateUser: firebase.RemoteConfigUser{Email: "a@example.com"}, UpdateOrigin: "REST_API", UpdateType: "ROLLBACK", ChangeNote: "known good",
...
func TestRenderCachedVersionsTablePlainText(t *testing.T) {
	...
	table := renderVersionsTable([]core.RemoteConfigVersionEntry{{VersionNumber: "7", Cached: true, CachedAt: cachedAt, Size: 1536}}, true)
